...
/** @addtogroup XNUCLEO_53L4A2
  * @{
  */

/** @addtogroup XNUCLEO_53L4A2_RANGING_SENSOR
  * @{
  */

/** @addtogroup XNUCLEO_53L4A2_RANGING_SENSOR_Exported_Variables
  * @{
  */
void *VL53L4A2_RANGING_SENSOR_CompObj[RANGING_SENSOR_INSTANCES_NBR] = {0};
/**
  * @}
  */

/** @defgroup XNUCLEO_53L4A2_RANGING_SENSOR_Private_Variables Private Variables
  * @{
  */
static RANGING_SENSOR_Drv_t *VL53L4A2_RANGING_SENSOR_Drv = NULL;
static RANGING_SENSOR_Capabilities_t VL53L4A2_RANGING_SENSOR_Cap;
/**
  * @}
  */

/** @defgroup XNUCLEO_53L4A2_RANGING_SENSOR_Private_Functions_Prototypes Private Functions Prototypes
  * @{
  */
...
/**
  ...
  * @retval BSP status
  */
int32_t VL53L4A2_RANGING_SENSOR_DeInit(uint32_t Instance)
{
  int32_t ret;
  ...
  else if (VL53L4A2_RANGING_SENSOR_Drv->DeInit(VL53L4A2_RANGING_SENSOR_CompObj[Instance]) < 0)
  {
