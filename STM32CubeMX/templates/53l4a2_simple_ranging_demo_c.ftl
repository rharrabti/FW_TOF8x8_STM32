...
[#if SWIP.defines??]
  [#list SWIP.defines as definition]
    ...
    [#if name.contains("TOF_RANGING_MODE")]
      [#assign flag_53l4a2_ranging_mode = value]
    [/#if]
    [#if name.contains("TOF_OFFSET_CALIBRATION")]
      [#assign flag_53l4a2_offset_calibration = value]
    [/#if]
    [#if name.contains("TOF_XTALK_CALIBRATION")]
      [#assign flag_53l4a2_xtalk_calibration = value]
    [/#if]
...
{
[#if flag_53l4a2_offset_calibration == "Yes"]
  uint8_t i;
...
[#if flag_53l4a2_xtalk_calibration == "Yes"]
  ...
  VL53L4A2_RANGING_SENSOR_XTalkCalibration(VL53L4A2_DEV_CENTER);
...
[/#if]
[#if flag_53l4a2_ranging_mode == "Interrupt"]

  status = VL53L4A2_RANGING_SENSOR_Start(VL53L4A2_DEV_CENTER, RS_MODE_ASYNC_CONTINUOUS);
...
[/#if]
[#if flag_53l4a2_ranging_mode == "Polling"]
