...
[#if SWIP.defines??]
  [#list SWIP.defines as definition]
    ...
    [#if name.contains("TOF_RANGING_MODE")]
      [#assign flag_53l7a1_ranging_mode = value]
    [/#if]
    [#if name.contains("TOF_XTALK_CALIBRATION")]
      [#assign flag_53l7a1_xtalk_calibration = value]
    [/#if]
...
static void MX_53L7A1_SimpleRanging_Process(void)
{
  ...
  [#if flag_53l7a1_xtalk_calibration == "Yes"]
...
[#if flag_53l7a1_xtalk_calibration == "Yes"]
  ...
  VL53L7A1_RANGING_SENSOR_XTalkCalibration(VL53L7A1_DEV_CENTER, reflectance, cal_distance);
  printf("--- END OF XTALK CALIBRATION ---\n");
[/#if]

[#if flag_53l7a1_ranging_mode == "Interrupt"]
...
[/#if]
[#if flag_53l7a1_ranging_mode == "Polling"]
...
static void toggle_resolution(void)
{
  ...
  VL53L7A1_RANGING_SENSOR_ConfigProfile(VL53L7A1_DEV_CENTER, &Profile);
[#if flag_53l7a1_ranging_mode == "Interrupt"]
  VL53L7A1_RANGING_SENSOR_Start(VL53L7A1_DEV_CENTER, RS_MODE_ASYNC_CONTINUOUS);
[/#if]
[#if flag_53l7a1_ranging_mode == "Polling"]
