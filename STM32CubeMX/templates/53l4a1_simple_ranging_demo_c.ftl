...
[#if SWIP.defines??]
  [#list SWIP.defines as definition]
    ...
    [#if name.contains("TOF_RANGING_MODE")]
      [#assign flag_53l4a1_ranging_mode = value]
    [/#if]
    [#if name.contains("TOF_OFFSET_CALIBRATION")]
      [#assign flag_53l4a1_offset_calibration = value]
    [/#if]
    [#if name.contains("TOF_XTALK_CALIBRATION")]
      [#assign flag_53l4a1_xtalk_calibration = value]
    [/#if]
...
{
[#if flag_53l4a1_offset_calibration == "Yes"]
  uint8_t i;
...
[#if flag_53l4a1_xtalk_calibration == "Yes"]
  ...
  VL53L4A1_RANGING_SENSOR_XTalkCalibration(VL53L4A1_DEV_CENTER);
...
[#if flag_53l4a1_offset_calibration == "Yes"]
  ...
  VL53L4A1_RANGING_SENSOR_Stop(VL53L4A1_DEV_CENTER);
  VL53L4A1_RANGING_SENSOR_OffsetCalibration(VL53L4A1_DEV_CENTER, cal_distance_mm);
  printf("--- END OF OFFSET CALIBRATION ---\n");
[/#if]
[#if flag_53l4a1_ranging_mode == "Interrupt"]
...
[/#if]
[#if flag_53l4a1_ranging_mode == "Polling"]
