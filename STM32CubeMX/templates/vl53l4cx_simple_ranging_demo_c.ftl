...
[#if SWIP.defines??]
  [#list SWIP.defines as definition]
    ...
    [#if name.contains("TOF_RANGING_MODE")]
      [#assign flag_VL53L4CX_ranging_mode = value]
    [/#if]
...
[#if flag_VL53L4CX_ranging_mode == "Interrupt"]

  status = CUSTOM_RANGING_SENSOR_Start(CUSTOM_VL53L4CX, RS_MODE_ASYNC_CONTINUOUS);
...
[/#if]
[#if flag_VL53L4CX_ranging_mode == "Polling"]
